...
// #define ALIEN_W [] = {14, 13, 45}
// #define ALIEN_H [] = {9, 10, 27}
...
//   ALLEGRO_BITMAP *sprite = al_create_sub_bitmap(spritesbd._sheet, x, y, w,
//   h); must_init(sprite, "sprite grab"); return sprite;
// }

// void sprites_init(SPRITESBD spritesbd) {
...
//   spritesbd.wall = sprite_grabBd(0, 48, TILE, TILE);

//   spritesbd.dirt = sprite_grabBd(48, 48, TILE, TILE);

//   spritesbd.jogador[0] = sprite_grabBd(0, 0, TILE, TILE);
//   spritesbd.jogador[1] = sprite_grabBd(16, 0, TILE, TILE);
//   spritesbd.jogador[2] = sprite_grabBd(32, 0, TILE, TILE);
//   spritesbd.jogador[3] = sprite_grabBd(48, 0, TILE, TILE);
//   spritesbd.jogador[4] = sprite_grabBd(64, 0, TILE, TILE);
//   spritesbd.jogador[5] = sprite_grabBd(80, 0, TILE, TILE);
//   spritesbd.jogador[6] = sprite_grabBd(96, 0, TILE, TILE);

//   spritesbd.jogadorEsq[0] = sprite_grabBd(0, 16, TILE, TILE);
//   spritesbd.jogadorEsq[1] = sprite_grabBd(16, 16, TILE, TILE);
//   spritesbd.jogadorEsq[2] = sprite_grabBd(32, 16, TILE, TILE);
//   spritesbd.jogadorEsq[3] = sprite_grabBd(48, 16, TILE, TILE);
//   spritesbd.jogadorEsq[4] = sprite_grabBd(64, 16, TILE, TILE);
//   spritesbd.jogadorEsq[5] = sprite_grabBd(80, 16, TILE, TILE);
//   spritesbd.jogadorEsq[6] = sprite_grabBd(96, 16, TILE, TILE);

//   spritesbd.jogadorDir[0] = sprite_grabBd(0, 32, TILE, TILE);
//   spritesbd.jogadorDir[1] = sprite_grabBd(16, 32, TILE, TILE);
//   spritesbd.jogadorDir[2] = sprite_grabBd(32, 32, TILE, TILE);
//   spritesbd.jogadorDir[3] = sprite_grabBd(48, 32, TILE, TILE);
//   spritesbd.jogadorDir[4] = sprite_grabBd(64, 32, TILE, TILE);
//   spritesbd.jogadorDir[5] = sprite_grabBd(80, 32, TILE, TILE);
//   spritesbd.jogadorDir[6] = sprite_grabBd(96, 32, TILE, TILE);

//   spritesbd.cristal[0] = sprite_grabBd(0, 64, TILE, TILE);
//   spritesbd.cristal[1] = sprite_grabBd(0, 80, TILE, TILE);
//   spritesbd.cristal[2] = sprite_grabBd(0, 96, TILE, TILE);
//   spritesbd.cristal[3] = sprite_grabBd(0, 112, TILE, TILE);
//   spritesbd.cristal[4] = sprite_grabBd(16, 64, TILE, TILE);
//   spritesbd.cristal[5] = sprite_grabBd(16, 80, TILE, TILE);
//   spritesbd.cristal[6] = sprite_grabBd(16, 96, TILE, TILE);
//   spritesbd.cristal[7] = sprite_grabBd(16, 112, TILE, TILE);
...
//     {
//       ALLEGRO_COLOR tint =
//           frame_display ? al_map_rgb_f(1, 1, 1) : al_map_rgb_f(0.5, 0.5,
//           0.5);
...
//   // if(shots[i].ship)
//   if (key[ALLEGRO_KEY_LEFT])
//     al_draw_bitmap(spritesbd.jogadorEsq[frame_display], player.x, player.y,
//     0);
//   else if (key[ALLEGRO_KEY_RIGHT])
//     al_draw_bitmap(spritesbd.jogadorDir[frame_display], player.x, player.y,
//     0);
//   else
...
//                 : al_map_rgb_f(0.5, 0.5, 0.5)
//             ;
//             al_draw_tinted_bitmap(sprites.alien_shot, tint, shots[i].x,
//             shots[i].y, 0);
//         }
// }
...
//     if (shots_collide(false, aliens[i].x, aliens[i].y,
//     ALIEN_W[aliens[i].type],
...
// void aliens_draw(SPRITES sprites) {
//   for (int i = 0; i < ALIENS_N; i++) {
//     if (!aliens[i].used)
//       continue;
//     if (aliens[i].blink > 2)
...
//     al_draw_bitmap(sprites.alien[aliens[i].type], aliens[i].x, aliens[i].y,
//     0);
//   }
// }
